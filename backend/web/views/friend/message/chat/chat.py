...
class MessageChatView(APIView):
    ...
    def event_stream(self, app, inputs, friend, message):
        ...
        yield "data: [DONE]\n\n"
        inputs_tokens = full_usage.get("input_tokens", 0)
        ...
        Message.objects.create(
            ...
            input=json.dumps(
                [m.model_dump() for m in inputs["messages"]], ensure_ascii=False
            )[:10000],
            output=full_output[:500],
            input_tokens=inputs_tokens,
